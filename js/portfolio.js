$(document).ready(function () {
  ...
  $('#intro .arrow').on('click', function(){
    ...
    $('html, body').stop().animate({scrollTop: $('#cnt1').offset().top}, 800, 'easeOutBack', a11y);
  ...
  $(window).on('scroll', function () {
    ...
    if (scrollY < stickyWrapY) { //스티키 상단영역
      ...
      $('#cnt2').find('.brand_txt').addClass('opacity hidden');
      ...
      $('#cnt2').find('.brand_txt').removeClass('opacity hidden');
